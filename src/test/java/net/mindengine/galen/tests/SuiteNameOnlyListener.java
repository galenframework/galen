...
public abstract class SuiteNameOnlyListener implements CompleteListener {
    ...
    @Override
    public void onAfterPage(GalenBasicTestRunner galenSuiteRunner,
            GalenPageRunner pageRunner, GalenPageTest pageTest,
            Browser browser) {
    }

    @Override
    public void onBeforePage(GalenBasicTestRunner galenSuiteRunner,
            GalenPageRunner pageRunner, GalenPageTest pageTest, Browser browser) {
    }

    @Override
    public void onSuiteFinished(GalenBasicTestRunner galenSuiteRunner,
            GalenBasicTest suite) {
    }

    @Override
    public abstract void onSuiteStarted(GalenBasicTestRunner galenSuiteRunner, GalenBasicTest suite);
