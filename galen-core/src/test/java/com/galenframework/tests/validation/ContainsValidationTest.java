...
public class ContainsValidationTest extends ValidationTestBase {
    ...
    public Object[][] provideBadSamples() {
        return new Object[][]{
            {validationResult(areas(new ValidationObject(new Rect(9, 11, 10, 10), "menu"), new ValidationObject(new Rect(10, 10, 100, 100), "object")),
                    messages("\"menu\" is outside \"object\""), emptyList()),
            ...
            {validationResult(areas(new ValidationObject(new Rect(50, 50, 110, 10), "menu"), new ValidationObject(new Rect(10, 10, 101, 40), "button"), new ValidationObject(new Rect(10, 10, 100, 100), "object")),
                    messages("\"menu\" is outside \"object\"", "\"button\" is outside \"object\""), emptyList()),
                specContains(false, "menu", "button"), page(new HashMap<String, PageElement>(){{
                    put("object", element(10, 10, 100, 100));
            ...
            {validationResult(NO_AREA, messages("\"menu\" is not visible on page"), emptyList()),
                specContains(CONTAINS_FULLY, "menu", "button"), page(new HashMap<String, PageElement>(){{
                    put("object", element(10, 10, 100, 100));
            ...
            {validationResult(NO_AREA, messages("\"menu\" is absent on page"), emptyList()),
                specContains(CONTAINS_FULLY, "menu", "button"), page(new HashMap<String, PageElement>(){{
                    put("object", element(10, 10, 100, 100));
            ...
            {validationResult(areas(new ValidationObject(new Rect(350, 10, 10, 10), "menu-item-3"), new ValidationObject(new Rect(0, 0, 200, 100), "object")),
                    messages("\"menu-item-3\" is outside \"object\""), emptyList()),
                specContains(CONTAINS_FULLY, "menu-item-*", "button"), page(new HashMap<String, PageElement>(){{
                    put("object", element(0, 0, 200, 100));
                    put("menu-item-1", element(10, 10, 10, 10));
                    put("menu-item-2", element(30, 10, 10, 10));
            ...
            {validationResult(NO_AREA, messages("There are no objects matching: menu-item-*"), emptyList()),
                specContains(CONTAINS_FULLY, "menu-item-*", "button"), page(new HashMap<String, PageElement>(){{
                    put("object", element(0, 0, 200, 100));
                    put("button", element(70, 10, 10, 10));
            }})}
